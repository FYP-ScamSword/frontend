...
import { retrieveContacts } from "~/server/scamchat.server";
...
export const loader = async () => {
  await connectToScamChatDatabase();

  var chats: Chat[] | null = null;
  var chatsError;

  try {
    chats = await retrieveContacts();
  } catch (error) {
    chatsError = error;
  }
...
export default function ChatPage() {
  ...
  console.log("test: " + retrieveContacts());
